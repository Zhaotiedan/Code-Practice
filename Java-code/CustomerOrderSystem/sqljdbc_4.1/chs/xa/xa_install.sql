...
-- distributed transaction and XA support for the Microsoft JDBC Driver 4.1 for SQL Server.
...
-- #2. Permissions to the distributed transaction support procedures for the Microsoft JDBC Driver 4.1 
...
-- in Microsoft JDBC Driver 4.1 for SQL Server distributed transactions.
